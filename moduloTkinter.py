...
class FormularioArticulos:
    ...
    def carga_articulos(self):
        ...
        # Bolsa
        self.label2=ttk.Label(self.labelframe1, text="Bolsa:")        
        ...
        self.entrybolsa.grid(column=1, row=2, padx=4, pady=4)
        # Boton
        self.boton1=ttk.Button(self.labelframe1, text="Confirmar", command=self.agregar)
        self.boton1.grid(column=1, row=3, padx=4, pady=4)

    def agregar(self):
        datos=(self.descripcioncarga.get(), self.bolsacarga.get(),self.preciocarga.get())
